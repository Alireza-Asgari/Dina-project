...
const Form = () => {
  ...
  const myForm = useFormik({
    validate: (values) => {
      ...
      if (!values.request) {
        errors.request = "لطفا یک مشکل یا درخواست را انتخاب کنید.";
      }
      if (!values.requestTitle) {
        errors.requestTitle = "وارد کردن این بخش اجباری است.";
      }
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <fieldset className="sm:col-span-4">
                  <h3 className="block text-base font-medium leading-6 text-gray-900 dark:text-white">
                    کدامیک از محصولات مارا استفاده میکنید؟{" "}
                  </h3>
                  <div className="mt-6 space-y-6">
                    ...
                    <div className="relative flex gap-x-3">
                      ...
                      <div className="text-sm leading-6">
                        <label
                          htmlFor="SocbamoMarketialNetworks"
                          className="block text-sm font-medium leading-6 text-gray-900 dark:text-mauve8"
                        >
                          سامانه فروشگاهی بامو مارکت{" "}
                        </label>
                      </div>
                    </div>
                    <div className="relative flex gap-x-3">
                      ...
                      <div className="text-sm leading-6">
                        <label
                          htmlFor="JewelryDistricts"
                          className="block text-sm font-medium leading-6 text-gray-900 dark:text-mauve8"
                        >
                          سامانه آنلاین کارگاهی و فروشگاهی Jewelry Districts{" "}
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-span-full">
                  <label
                    ...
                    className="block text-sm font-medium leading-6 text-gray-900 dark:text-mauve8"
                  >
                    برای درخواست خود عنوان مناسبی وارد کنید
                  </label>
                  <div className="mt-2">
                    <textarea
                      name="requestTitle"
                      id="requestTitle"
                      value={myForm.values.requestTitle}
                      onChange={myForm.handleChange}
                      onBlur={myForm.handleBlur}
                      rows={2}
                      className="block w-full outline-none px-2 rounded-md dark:text-mauve4 border-0 dark:bg-bgDarkInner dark:ring-borderColorLight py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-borderDark sm:text-sm sm:leading-6"
                    />
                    {myForm.errors.requestTitle &&
                      myForm.touched.requestTitle && (
                        <p className="text-red-400 mt-2">
                          {myForm.errors.requestTitle}
                        </p>
                      )}
                ...
                <fieldset className="sm:col-span-4">
                  <h3 className="block text-base font-medium leading-6 text-gray-900 dark:text-white">
                    مشکل و درخواست شما در چه زمینه ای است؟
                  </h3>
                  <div className="mt-6 space-y-6">
                    <div className="relative flex gap-x-3">
                      <div className="flex h-6 items-center">
                    ...
                    <div className="relative flex gap-x-3">
                      <div className="flex h-6 items-center">
                        <input
                          id="questionsGuidance"
                          name="request"
                          value="Ask questions and receive guidance"
                          onChange={myForm.handleChange}
                          type="radio"
                          className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"
                        />
                      ...
                      <div className="text-sm leading-6">
                        <label
                          htmlFor="questionsGuidance"
                          className="block text-sm font-medium leading-6 text-gray-900 dark:text-mauve8"
                        >
                          طرح سوال و دریافت راهنمایی
                        </label>
                      </div>
                    </div>
                  </div>
                  {myForm.errors.request && myForm.touched.request && (
                    <p className="text-red-400 mt-2">{myForm.errors.request}</p>
                  )}
                </fieldset>
                ...
                <div className="col-span-full">
                  <label
                    ...
                    className="block text-sm font-medium leading-6 text-gray-900 dark:text-mauve8"
                  >
                    لطفا شرح مناسبی از درخواست و یا مشکلی که با آن مواجه شده اید
                    را شرح دهید :
                  </label>
                  <div className="mt-2">
                    <textarea
                ...
                <div className="col-span-full">
                  ...
                  >
                    درصورتی که فایل و یا مستنداتی دردست دارید که به کشف دقیق تر
                    و رفع مشکل شما کمک میکند آن را ضمیمه کنید.
                  </label>
                  <div
